        ...
        <React.Fragment>
          ...
          >
            ...
            >
              ...
              >
                Liste des vendeurs ({paginatedVendors.length} sur{" "}
                ...
                <div className="text-center p-6">
                  ...
                  <div className="text-sm text-muted mt-1">
                    {search
                      ...
                      : "Commencez par ajouter un vendeur"}
                  </div>
                </div>
              ) : (
                paginatedVendors.map((vendor, index) => (
                  ...
                  >
                    ...
                    <div className="d-md-none w-100">
                      <div className="mb-2">
                        <div className="font-semibold text-primary mb-1">
                          {vendor.NomVendeur} {vendor.PrenomVendeur}
                        </div>
                    ...
                    <div className="d-none d-md-flex w-100 align-items-center">
                      ...
                      <div className="col-2">{vendor.PrenomVendeur}</div>
                      <div className="col-2 text-sm">{vendor.CIN}</div>
                      <div className="col-3 text-sm">{vendor.Email}</div>
                      <div className="col-2">
