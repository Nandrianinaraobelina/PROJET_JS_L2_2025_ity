...
function Clients() {
  ...
  return (
    <div className="section-card-modern fade-in">
      ...
      <form
        className="row g-2 g-md-3 mb-4 mb-md-6 fade-in"
        style={{ marginBottom: "2rem" }}
          ...
          {formError && (
            ...
            >
              <div className="d-flex align-items-start align-items-sm-center">
                <i
                  className="bi bi-exclamation-triangle me-2 mt-1 mt-sm-0"
        ...
        <React.Fragment>
          ...
          >
            ...
            >
              ...
              >
                Liste des clients ({paginatedClients.length} sur{" "}
                ...
                paginatedClients.map((cli, index) => (
                  ...
                  >
                    ...
                    <div className="d-md-none w-100">
                      <div className="mb-2">
                        ...
                        <div className="d-flex gap-1 justify-content-end">
                          <button
                            className="btn btn-sm btn-outline-primary btn-modern btn-compact"
                    ...
                    <div className="d-none d-md-flex w-100 align-items-center">
                      ...
                      <div className="col-2 font-semibold">{cli.NomCli}</div>
                      <div className="col-2">{cli.PrenomCli}</div>
                      <div className="col-3 text-sm">{cli.EmailCli}</div>
          ...
          {showModal && selectedClient && (
            ...
            >
              ...
              >
                ...
                {/* Pied du modal */}
                <div
                  className="p-4 border-top text-center"
                  style={{ borderColor: "var(--neutral-200) !important" }}
                >
                  <button
                    type="button"
          ...
          {filteredClients.length > 0 && (
            <div className="d-flex justify-content-center align-items-center mt-3 mt-md-4 px-2 px-md-0">
              <div className="d-flex align-items-center gap-2 gap-md-3">
                ...
                <span
                  className="text-sm font-semibold px-3 py-2 border-radius-lg d-none d-sm-inline-block"
                  style={{
                    background: "var(--neutral-100)",
                ...
                <span
                  className="text-xs font-semibold px-2 py-1 border-radius-lg d-sm-none"
                  style={{
                    background: "var(--neutral-100)",
                    color: "var(--neutral-700)",
                    minWidth: "50px",
